...
# Line 2: Current path (always shown)
...
- `↯` - Current path indicator (line 2 leading)
- `▸` - Separator between segments of line 1 (percentage/balance, effort, branch and PR, time)
